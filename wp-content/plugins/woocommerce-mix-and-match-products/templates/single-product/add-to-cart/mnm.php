	...
	<form method="post" enctype="multipart/form-data" class="mnm_form cart cart_group">
		...
		<div class="mnm_cart cart" <?php echo $product->get_data_attributes(); ?>>
			...
			<div class="mnm_button_wrap" style="display:block">
				...
				<?php 
					$message = $container_size > 0 ? sprintf( __( 'Please select %s items to continue&hellip;', 'woocommerce-mix-and-match-products' ), $container_size ) : __( 'Please select some items to continue&hellip;', 'woocommerce-mix-and-match-products' ); 
