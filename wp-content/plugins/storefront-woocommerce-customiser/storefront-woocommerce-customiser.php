...
final class Storefront_WooCommerce_Customiser {
	...
	public function swc_homepage_product_categories_view_more() {
		...
		if ( '' != $url ) {
			echo '<p class="clearfix"><a href="' . esc_url( $url ) . '" class="button alignright">' . __( 'View more product categories', 'storefront-woocommerce-customiser' ) . '</a></p>';
		}
	}
	...
	public function swc_homepage_recent_products_view_more() {
		...
		if ( '' != $url ) {
			echo '<p class="clearfix"><a href="' . esc_url( $url ) . '" class="button alignright">' . __( 'View more new products', 'storefront-woocommerce-customiser' ) . '</a></p>';
		}
	}
	...
	public function swc_homepage_featured_products_view_more() {
		...
		if ( '' != $url ) {
			echo '<p class="clearfix"><a href="' . esc_url( $url ) . '" class="button alignright">' . __( 'View more featured products', 'storefront-woocommerce-customiser' ) . '</a></p>';
		}
	}
	...
	public function swc_homepage_top_rated_products_view_more() {
		...
		if ( '' != $url ) {
			echo '<p class="clearfix"><a href="' . esc_url( $url ) . '" class="button alignright">' . __( 'View more popular products', 'storefront-woocommerce-customiser' ) . '</a></p>';
		}
	}
	...
	public function swc_homepage_on_sale_products_view_more() {
		...
		if ( '' != $url ) {
			echo '<p class="clearfix"><a href="' . esc_url( $url ) . '" class="button alignright">' . __( 'View more products on sale', 'storefront-woocommerce-customiser' ) . '</a></p>';
		}
	}
	 ...
	 * @return void
	 */
	function swc_scroll_wrapper_close() {
		$infinite_scroll = get_theme_mod( 'swc_infinite_scroll', false );
